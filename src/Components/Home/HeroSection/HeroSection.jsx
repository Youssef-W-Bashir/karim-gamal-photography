    ...
    <>
      ...
      >
        <div className="overlay p-4 mx-auto bg-black/40 h-full">
          ...
          <p className="uppercase text-2xl md:text-5xl drop-shadow-glow tracking-wider text-white text-center font-permanentMarker">
